...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Sounds Venlo USF listing-price pipeline.")
...
def main() -> int:
    ...
    print("[PIPELINE] Sounds Venlo USF listing-price pipeline", flush=True)
    print(
        "[PIPELINE] config",
        {
    ...
    run_step("refresh_soundsvenlo_listing_prices", command)
