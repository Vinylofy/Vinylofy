...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Stage Music On Vinyl raw snapshots naar staged_offers."
    )
...
def main() -> int:
    ...
    print(
        f"[STAGE] shop={SHOP_ID} candidates={result.candidates} inserted={result.inserted} "
        f"skipped={result.skipped} write={args.write}",
        flush=True,
    )
