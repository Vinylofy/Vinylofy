...
from scripts.scrapers.usf.jobs.discover_soundsvenlo import (
    SHOP_COUNTRY,
    SHOP_DOMAIN,
    SHOP_ID,
    SHOP_NAME,
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Fast Sounds Venlo listing price refresh into public prices.")
    ...
    parser.add_argument(
        "--fast-price-sync",
        action="store_true",
        help="Price-only bulk update vanuit shop_product_links naar bestaande prices, zoals ROV.",
    )
