              ...
              >
                ...
                <div className="md:text-right">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center justify-center rounded-full bg-[#e67e22] px-3.5 py-2 text-xs font-semibold transition hover:bg-[#cf6e18] md:text-sm !text-white hover:!text-white"
                  >
                    Ga naar shop
                  </a>
                </div>
